...
/** Arm Compiler 5 未实现 __builtin_unreachable()，会把它当作外部函数 unreachable 调用，
 *  导致链接报 L6218E。此处覆盖为死循环，与 LVGL 默认（非 GCC 分支）行为一致。
 */
 ...
 */
#define LV_ATTRIBUTE_CUSTOM_INCLUDE "lvgl_attr.h"
